...
public class Satelite extends Astro {
	...
	public enum DatosSatelite {
		TIERRA(1.2, 0.487, 0.48293739, 1.2),
		LUNA(0.273, ESCALA_ORBITA_SATELITE * 0.00257, ESCALA_ORBITA_SATELITE * 0.002566, 0.0739),
		MERCURIO(0.4, 0.277, 0.27293739, 0.3),
		VENUS(1.1, 0.377, 0.37293739, 0.7),
		MARTE(0.6, 0.587, 0.58293739, 2.4),
		JUPITER(3.0, 0.877, 0.87293739, 10.2),
		SATURNO(2.5, 1.077, 1.07293739, 23.2),
		URANO(2.1, 1.277, 1.27293739, 37.0),
		NEPTUNO(2.0, 1.427, 1.42293739, 47.0),
		PLUTON(0.5, 1.577, 1.57293739, 55.0),
