...
public class IUContactos {
	...
	/*
  * En esta sección del método se hizo lo mismo que con el Nombre
  * Solo que ahora es la direccion y el telefono, en el método lo que pasa
  * Es que a las variable se les están asignando cadenas de tipo String
  * Y se usa el scanner para que la máquina lea la cadena escrita, para
  * guardarla.
  */
