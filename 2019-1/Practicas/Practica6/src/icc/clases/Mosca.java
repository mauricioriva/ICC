...
public class Mosca {
	 ...
	 */
	public String canta() {
    /*Agregue una variable llamada cambio que va a remplazar todas
    las letras que aparecen en el parentesis por una ya definida llama vocal
    */
    String cambio = original.replaceAll("[a|e|i|o|u|U]", vocal + "");
    return cambio;
	}
}
